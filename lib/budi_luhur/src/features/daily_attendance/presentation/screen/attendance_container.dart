      ...
      child: TableCalendar(
        ...
        selectedDayPredicate: (dateTime) {
          return absentDays.indexWhere(
                (date) =>
                    Utils.formatDate(dateTime) == Utils.formatDate(date.date),
              ) !=
              -1;
        },
        ...
        onDaySelected: (selected, focused) {
          ...
          final selectedAttendance = dailyAttendanceList.firstWhere(
            (date) => isSameDay(date.date.toLocal(), selected),
          ...
          final dataSelectedAttendance = DailyAttendance(
            ...
            schoolSession: selectedAttendance.schoolSession,
            semester: selectedAttendance.semester,
            date: selectedAttendance.date,
            reason: selectedAttendance.reason,
            checkInClock: selectedAttendance.checkInClock,
            checkOutClock: selectedAttendance.checkOutClock,
        ...
        calendarBuilders: CalendarBuilders(
          markerBuilder: (context, date, events) {
            ...
            final a = (dailyAttendanceList.where(
              (d) => Utils.formatDate(d.date) == Utils.formatDate(date),
            )).toList();
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        dailyAttendance.reason ?? dailyAttendance.status,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              dailyAttendance.checkInClock != null
                                  ? Utils.formatTime(
                                      dailyAttendance.checkInClock!.toLocal(),
                                    )
                                  : "-",
                              style: Theme.of(context).textTheme.bodyLarge
                                  ?.copyWith(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              dailyAttendance.checkOutClock != null
                                  ? Utils.formatTime(
                                      dailyAttendance.checkOutClock!.toLocal(),
                                    )
                                  : "-",
                              style: Theme.of(context).textTheme.bodyLarge
                                  ?.copyWith(
